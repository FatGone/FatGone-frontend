  ...
  <div class="wrapper h100">
    <div class="content justContCenter itemsCenter" style="margin: 0 10%;">
      ...
      <div class="content w100 itemsCenter" style="margin-top: 50px">
        <h1 class="flex">Uzupełnij swoje dane</h1>
        <div class="formWrapper">
          <form>
            <div class="flex">
              <input v-model="firstName"/>
              <label class="floatingLabel" style="top: 0px;">Imię</label>
              <input v-model="lastName"/>
              <label class="floatingLabel" style="top: 0px; left: 55%;">Nazwisko</label>
            </div>
            <div class="flex">
              <input v-model="street"/>
              <label class="floatingLabel" style="top: 0px;">Ulica</label>
              <input v-model="buildNumber" style="width: 40%"/>
              <label class="floatingLabel" style="top: 0px; left: 73%;">Numer domu</label>
            </div>
            <div class="flex">
              <input v-model="apartmentNumber"/>
              <label class="floatingLabel" style="top: 0px;">Numer mieszkania</label>
              <input v-model="zip"/>
              <label class="floatingLabel" style="top: 0px; left: 55%;">Kod pocztowy</label>
            </div>
            <div class="flex">
              <input v-model="city"/>
              <label class="floatingLabel" style="top: 0px;">Miasto</label>
            </div>
            <span>{{ error }}</span>
            <div class="flex">
