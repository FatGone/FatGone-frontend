...
import { EmailOrPasswordIncorrectException, ServerError, UnprocessableEntityException, type AppException } from "@/common/models/AppException";
...
import type { UnprocessableEntityDto } from "@/auth/models/dtos/UnprocessedEntityDto";
